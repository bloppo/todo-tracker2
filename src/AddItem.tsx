...
const AddItem = () => {
    ...
    const goodDate = (value: Date) => {
        ...
        console.log(isAfter(value,date2));
        return isAfter(value,date2);
    }

    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Box className="add-item" sx={{ p: 2 }}>
                    ...
                    <Stack spacing={2}>
                        ...
                        />
                            ...
                            <Controller
                                ...
                                defaultValue={null}
                                control={control}
                                rules={{ required: true, validate: value => goodDate(value) || 'Due Date must be after 2025-08-15' }}
                                ...
                                <DatePicker
                                    ...
                                    slotProps={{textField: {variant: 'filled',
                                                            ...
                                                            sx: {backgroundColor:'white', width:200}} as Partial<TextFieldProps>}}
                                />
                                )}
                            />
                        <Button
