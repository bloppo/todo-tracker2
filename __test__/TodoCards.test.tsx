...
vi.mock('../src/Dialogs/DeleteDialog', () => ({
  default: ({ openDialog, description, handleCancel, handleConfirmDelete }: { openDialog: boolean; description: string; handleCancel: () => void; handleConfirmDelete: () => void }) => (
    openDialog ? (
...
vi.mock('../src/AppState', () => ({
  __esModule: true,
  default: (selector: (state: { removeTodo: typeof removeTodoMock; completedTodo: typeof completedTodoMock }) => (recno: number) => boolean) => selector({
